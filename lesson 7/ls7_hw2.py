...
coat = Coat(52)
print(f'Расход ткани на пальто {coat.square}')
costume = Costume(185)
print(f'Расход такни на костюм {costume.square}')
print(f'Общий расход ткани {coat.square + costume.square}')