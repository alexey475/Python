...
class Matrix:
    ...
    def __add__(self, other):
        # result_list = []
        # for str1, str2 in zip(self.my_list, other.my_list):
        #     result_list.append(i + j for i, j in zip(str1, str2))
        result_list = [[i + j for i, j in zip(str1, str2)]for str1, str2 in zip(self.my_list, other.my_list)]
